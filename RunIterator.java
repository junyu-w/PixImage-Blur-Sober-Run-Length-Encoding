...
public class RunIterator implements Iterator {
   ...
   */
  private DList iteratedList;
  private DListNode nodeOfList;
  ...
  // the encoding.
  RunIterator(DList rleDlist) {
    iteratedList = rleDlist;
    nodeOfList = rleDlist.head;
    //System.out.println(rleDlist.head);
    //System.out.println(rleDlist);
  ...
  public boolean hasNext() {
    ...
    if (nodeOfList != null) {   //??without .next good
      return true;
    }else {
      return false;
    }
  ...
  public int[] next() {
    ...
    // Replace the following line with your solution.
    int[] rleArray = new int[4];
    if (this.hasNext()==true) {
      rleArray[0] = nodeOfList.lengthOfRun;
      rleArray[1] = nodeOfList.redIntensity;
      rleArray[2] = nodeOfList.greenIntensity;
      rleArray[3] = nodeOfList.blueIntensity;
      //System.out.println(nodeOfList);
      nodeOfList = nodeOfList.next;
      //System.out.println("("+rleArray[0]+rleArray[1]+rleArray[2]+rleArray[3]+")");
      //System.out.println(nodeOfList);
    }else {
